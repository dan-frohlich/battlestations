...
var abilities = []SpecialAbility{
	...
	{Name: "Bosun", Pool: "5", Summary: "Remote penalty 1 lower. Reroll pool of 5 for battlestation actions", Types: []AbilityType{}},
	...
	{Name: "Calm", Pool: "rank x 2", Summary: "May take an “8” on a skill check instead of (and before) rolling the dice. Pool of Rank x2", Types: []AbilityType{}},
	...
	{Name: "Cannon Specialist", Pool: "Combat x2", Summary: "Pool to reroll attacks, reconfigure, or repair a cannon module. Pool of Combat x2", Types: []AbilityType{}},
	...
	{Name: "Cortex Overloader", Pool: "combat + psionics", Summary: "Pool to blow up people's heads Psionically. Pool of Combat + Psionics", Types: []AbilityType{}},
	{Name: "Courtier", Summary: "Move & act in slagged squares as though not slagged. Others may spend your luck", Types: []AbilityType{}},
	{Name: "Crafty", Pool: "science", Summary: "Checkup, Focus Sensors, Tune Shields. Pool of Science", Types: []AbilityType{}},
	{Name: "Cutthroat", Pool: "science x 2", Summary: "Spend from this pool to reroll a damage die you deal directly in personal combat. Pool of Science x2", Types: []AbilityType{}},
	...
	{Name: "Destroyer", Pool: "athletics + psionics", Summary: "Free action to release a Psionic energy blast like satchel charge in your square. Pool of Athletics + Psionics", Types: []AbilityType{}},
	...
	{Name: "Displaced", Pool: "athletics + psionics", Summary: "Psionically shimmer to add +3 to your target number until end of phase. Pool of Athletics + Psionics", Types: []AbilityType{}},
	{Name: "Doctor", Pool: "science x 2", Summary: "Pool to reroll skill checks to heal, detoxify, etc. or on the healing dice. Pool of Science x2", Types: []AbilityType{}},
	...
	{Name: "Empowered", Pool: "Engineering + Psionics", Summary: "Spend Ship's power as though it were luck. Reallocate power. Pool of Engineering + Psionics", Types: []AbilityType{}},
	{Name: "EMT", Pool: "Combat x2", Summary: "Pre-emptively heal incoming damage. Pool of Combat x2", Types: []AbilityType{}},
	{Name: "Energy Deflector", Summary: "Combat 11 to negate direct attack. Difficulty goes up by 1 for each use", Types: []AbilityType{}},
	{Name: "Engine Overloader", Pool: "Engineering x2", Summary: "Pool to make Engine pump +2 per extra power but satchel charge detonates. Pool of Engineering x2", Types: []AbilityType{}},
	{Name: "Engine Specialist", Pool: "Engineering x2", Summary: "Pool of rerolls to use when pumping, transferring power, or repairing an engine. Pool of Engineering x2", Types: []AbilityType{}},
	...
	{Name: "Fire Starter", Pool: "Combat + Psionics", Summary: "Start fires with your mind. Pool of Combat + Psionics", Types: []AbilityType{}},
	...
	{Name: "Ghost in The Machine", Pool: "Engineering + Psionics", Summary: "Operate a Battlestation from anywhere aboard ship at no remote penalty. Pool of Engineering + Psionics", Types: []AbilityType{}},
	...
	{Name: "Hardened", Pool: "5", Summary: "Pool to reroll a die that deals damage to you. Pool of 5", Types: []AbilityType{}},
	...
	{Name: "Empath", Pool: "Engineering + Psionics", Summary: "You may suffer to reroll hull damage dice your ship is taking. Pool of Engineering + Psionics", Types: []AbilityType{}},
	...
	{Name: "Intuitive", Pool: "Science + Psionics", Summary: "Add Psionics skill to scan or ask questions. Pool to ask yes/no or enemy's action. Pool of Science + Psionics", Types: []AbilityType{}},
	...
	{Name: "Mechanical Empath", Pool: "Engineering + Psionics", Summary: "Repair remotely as a free action. Pool of Engineering + Psionics", Types: []AbilityType{}},
	...
	{Name: "Numb Runner", Pool: "Athletics + Rank", Summary: "Ignore toxins and drug side effects. Dose as free action. Your toxins hard to resist. Pool of Athletics + Rank", Types: []AbilityType{}},
	...
	{Name: "Omniscient", Pool: "Science + Psionics", Summary: "Pool to ask ANY questions. Add Psionics when hacking or gathering data. Pool of Science + Psionics", Types: []AbilityType{}},
	{Name: "Overloader", Pool: "Engineering x2", Summary: "Pool to fire with bonus guns power but satchel charge in your square. Pool of Engineering x2", Types: []AbilityType{}},
	...
	{Name: "Polarizer", Pool: "Science + Psionics", Summary: "Pool to EMP or De-EMP objects in L.O.S. Pool of Science + Psionics", Types: []AbilityType{}},
	...
	{Name: "Psychic Blaster", Pool: "Combat + Psionics", Summary: "Pool to deal 1d6+successes as damage ignoring damage reduction. Pool of Combat + Psionics", Types: []AbilityType{}},
	{Name: "Psychic Shifter", Pool: "Piloting + Psionics", Summary: "Pool to move yourself to another module with your mind. Pool of Piloting + Psionics", Types: []AbilityType{}},
	{Name: "Psychic Stunner", Pool: "Athletics + Psionics", Summary: "Pool to add a stun effect to a direct attack. Pool of Athletics + Psionics", Types: []AbilityType{}},
	{Name: "Puppeteer", Pool: "Diplomacy + Psionics", Summary: "Pool to select target's next action. Pool of Diplomacy + Psionics", Types: []AbilityType{}},
	...
	{Name: "Resourceful", Pool: "Engineering _ Science", Summary: "Sub Science or Engineering for any other skill. Pool of Engineering or Science (whichever is lower)", OutputSummary: "sub Sci/Eng for any skill", Types: []AbilityType{}},
	{Name: "Rolls With It", Pool: "Piloting", Summary: "Pool to count OOC as a bonus insteaAbilityd of a penalty to your action or move. Pool of Piloting", Types: []AbilityType{}},
	...
	{Name: "Seer", Pool: "Science + Psionics", Summary: "Line of sight to anywhere aboard the ship or get scans as a free action. Pool of Science + Psionics", Types: []AbilityType{}},
	{Name: "Sharpshooter", Pool: "Combat x2", Summary: "Reroll allocation with ship's weapons or attacks with direct personal ranged attacks. Pool of Combat x2", Types: []AbilityType{}},
	{Name: "Shield Harmonizer", Summary: "Target's shields become 1 lower, yours are 1 higher", Types: []AbilityType{}},
	{Name: "Shock Trooper", Pool: "Combat x2", Summary: "You may go on overwatch as a free action at the end of your move action. Pool of Combat x2", Types: []AbilityType{}},
	{Name: "Slipster", Pool: "Athletics + Psionics", Summary: "Move through walls during movement. Pool of Athletics + Psionics", Types: []AbilityType{}},
	{Name: "Smooth", Pool: "Athletics + Rank", Summary: "Take actions that don't require skill check or include movement. Pool of Athletics + Rank", Types: []AbilityType{}},
	...
	{Name: "Spacer", Pool: "5", Summary: "5 rerolls for use in any skill check. Pool of 5", Types: []AbilityType{}},
	{Name: "Speed Demon", Pool: "Piloting x2", Summary: "Reroll acceleration and Fighter movement checks. Pool of Piloting x2", Types: []AbilityType{}},
	...
	{Name: "Sympathetic", Pool: "Athletics + Psionics", Summary: "Your attacker also suffers the highest die of damage. Pool of Athletics + Psionics", Types: []AbilityType{}},
	{Name: "Tailgunner", Pool: "Combat + Piloting", Summary: "Reroll Combat checks when firing a fighter's gun. Go on overwatch with Fighter. Pool of Combat + Piloting", Types: []AbilityType{}},
	{Name: "Telekinetic", Pool: "Athletics + Psionics", Summary: "Pool to move stuff with your mind. Pool of Athletics + Psionics", Types: []AbilityType{}},
	{Name: "Teleporter Specialist", Pool: "Science x2", Summary: "Count 1/2 used markers on Teleporter. Reroll pool for skill checks, allocation. Pool of Science x2", Types: []AbilityType{}},
	...
	{Name: "Tricky", Pool: "Engineering", Summary: "Pool to distract microships with trash, focus sensors, or steady ship. Pool of Engineering", Types: []AbilityType{}},
	{Name: "Turn Specialist", Pool: "piloting x 2", Summary: "Pool to reroll maneuvers to turn, dodge, ram, or sideslip. Pool of Piloting x2", Types: []AbilityType{}},
	{Name: "Unconventional", Pool: "Science", Summary: "Pool to roll an additional die alongside your skill check. Odd it adds. Even it subtracts. Pool of Science", Types: []AbilityType{}},
	{Name: "Unflappable", Pool: "rank", Summary: "Pool to ignore a total of up to +3 in penalties each time you use this ability. Pool of Rank", Types: []AbilityType{}},
	{Name: "Uniminded", Pool: "5", Summary: "You may use an ally's skill instead of your own as long as that ally is within Line Of Sight. Pool of 5", Types: []AbilityType{}},
	...
	{Name: "Unsinkable", Pool: "10", Summary: "Pool to reroll passive checks such as ship’s hull check, disintegration, stun, death, etc.. Pool of 10", Types: []AbilityType{}},
	...
	{Name: "Wrestler", Pool: "Athletics x2", Summary: "Choose to apply up to three different effects. Also a pool of rerolls to use in grapples. Pool of Athletics x2", Types: []AbilityType{}},
